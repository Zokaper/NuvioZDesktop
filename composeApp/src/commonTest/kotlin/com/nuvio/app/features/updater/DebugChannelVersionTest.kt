...
class DebugChannelVersionTest {
    ...
    fun `stable and debug channel eligibility is fail closed`() {
        ...
        val cases = listOf(
            ChannelReleaseFacts("0.1.23-alpha-z6+131", draft = false, prerelease = false) to (true to false),
            ChannelReleaseFacts("v0.1.23-alpha-z6+131", draft = false, prerelease = false) to (true to false),
            ChannelReleaseFacts("0.1.23-alpha-z6+131", draft = false, prerelease = true) to (false to false),
            ChannelReleaseFacts("debug-v0.1.23-alpha-z6.61", draft = false, prerelease = true) to (false to true),
            ChannelReleaseFacts("debug-v0.1.23-alpha-z6.61", draft = false, prerelease = false) to (false to false),
            ChannelReleaseFacts("debug-v0.1.23-alpha-z6.61", draft = true, prerelease = true) to (false to false),
        )
